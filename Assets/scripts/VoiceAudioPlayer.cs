...
public class VoiceAudioPlayer : MonoBehaviour
{
    ...
    public void AudioPlay(int index)
    {
        ...
        audioSource.loop = false;           //匠人模式:0遊戲敘述 1進入選主題 2風格 3主體 4年齡 5姿勢 6參考圖 7表情 8色調 9背景 10解析度 11細節 12生圖 13朝代 14食物主體 15進入溝通場景 16進入確認場景 17回答兩次後 18回答四次後
                                            //猜題模式:0遊戲敘述 1題目生好時 2答對時 3答案重複時 4答錯時 5缺少選區域按提交時 6缺少填回答按提交時 7分數大於等於100時 8分數大於等於60時 9 分數小於60時 10 說明結算場景 11 結算場景框住某個區域時
                                            // 確保 Recorder 傳輸音頻
        recorder.TransmitEnabled = true;
